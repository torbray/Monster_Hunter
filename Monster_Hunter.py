...
class Player:
    ...
    def show_inventory(self):
        ...
        print("---------------------")
        print(f"| {self.inventory[0]} | {self.inventory[1]} | {self.inventory[2]} | {self.inventory[3]} | {self.inventory[4]} |")
        print("---------------------")
        print(f"| {self.inventory[5]} | {self.inventory[6]} | {self.inventory[7]} | {self.inventory[8]} | {self.inventory[9]} |")
        print("---------------------")
        print("------Equipped-------")
        print("---------------------")
        print("       Helmet        \n")
